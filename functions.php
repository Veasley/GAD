...
function add_custom_archive_header(){ ?>
  ...
  <?php if ( is_archive() || is_search() ) : ?>
	  ...
	  <div class="custom-header-container">
	      ...
	      <!-- our custom header codes here -->
	      <div id="x-section-1" class="x-section _before _overlay-grey inner-page-hero bg-image" style="margin: 0px;padding: 5% 0px; background-image: url(http://gad.dev/wp-content/uploads/2016/12/gad-about.jpg); background-color: transparent;" data-x-element="section" data-x-params="{&quot;type&quot;:&quot;image&quot;,&quot;parallax&quot;:false}">
              <div class="x-container max width" style="margin: 0px auto;padding: 0px;">
                  <div class="x-column x-sm x-1-1" style="padding: 0px; opacity: 1; transition-duration: 750ms; transform: translate(0px, 0px);" data-x-element="column" data-x-params="{&quot;fade&quot;:true}" data-fade="true">
